...
<head>
    ...
    <link rel="shortcut icon" href="/atest/Public/assets/ico/favicon.html">
    <link href="/atest/Public/assets/css/bootstrap.css" rel="stylesheet">
    <link href="/atest/Public/assets/css/theme.css" rel="stylesheet">
    <link href="/atest/Public/assets/css/font-awesome.min.css" rel="stylesheet">
    <link href="/atest/Public/assets/css/alertify.css" rel="stylesheet">
    ...
    <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container-fluid">
                <div class="logo">
                    <img src="/atest/Public/assets/img/logo.png" alt="Realm Admin Template">
                </div>
                ...
                <div class="top-menu visible-desktop">
                    <ul class="pull-left">
                        ...
                        <li><a id="notifications" data-notification="3" href="#"><i class="icon-globe"></i>
                            Notifications</a></li>
                    </ul>
                    <ul class="pull-right">
    ...
    <div class="container-fluid">
        ...
        <div class="sidebar-nav nav-collapse collapse">
            <div class="user_side clearfix">
                <img src="/atest/Public/assets/img/odinn.jpg" alt="Odinn god of Thunder">
                <h5>Odinn</h5>
            ...
            <div class="accordion" id="accordion2">
                <div class="accordion-group">
                    <div class="accordion-heading">
                        <a class="accordion-toggle active b_F79999" href="index-2.html"><i class="icon-dashboard"></i>
                ...
                <div class="accordion-group">
                    <div class="accordion-heading">
                        <a class="accordion-toggle b_C3F7A7 collapsed" data-toggle="collapse" data-parent="#accordion2"
                           href="#collapse1"><i class="icon-magic"></i> <span>Features</span></a>
                    </div>
                    <div id="collapse1" class="accordion-body collapse">
                        <div class="accordion-inner">
                            <a class="accordion-toggle" href="ui_features.html"><i class="icon-star"></i> UI
                                Features</a>
                ...
                <div class="accordion-group">
                    <div class="accordion-heading">
                        <a class="accordion-toggle b_F6F1A2" href="tasks.html"><i class="icon-tasks"></i>
                            <span>Tasks</span></a>
                    </div>
                </div>
                <div class="accordion-group">
                ...
                <div class="accordion-group">
                    <div class="accordion-heading">
                        <a class="accordion-toggle b_F5C294" href="users.html"><i class="icon-user"></i>
                            <span>Users</span></a>
                    </div>
                </div>
            </div>
        ...
        <div class="main_container" id="dashboard_page">
            ...
            <div class="row-fluid">
                ...
                <div class="widget span8">
                    <div class="widget-header">
                        ...
                        <div class="widget-buttons">
                            <button class="btn btn-info btn-small" type="button"><i class="icon-plus"></i> See more
                            </button>
                            <a href="javascript:void(0)" class="collapse" data-collapsed="false"><i
                                    data-title="Collapse" class="icon-chevron-up"></i></a>
                        </div>
                ...
                <div class="widget widget-padding span4">
                    ...
                    <div class="widget-body" style="min-height: 170px;">
                        <div class="row-fluid" style="margin-bottom:15px;">
                            <a class="btn btn-small btn-box bubble bubble-info span4 tips" href="#"
                               data-title="bubble-info" data-bubble="7k"><i
                                    class="icon-thumbs-up"></i><span>Likes</span></a>
                            <a class="btn btn-small btn-box bubble bubble-info span4 tips" href="#"
                               data-title="bubble-info" data-bubble="10"><i class="icon-twitter"></i><span>Tweets</span></a>
                            <a class="btn btn-small btn-box span4 " href="#"><i
                                    class="icon-money"></i><span>Finance</span></a>
                        </div><!-- /row-fluid -->
                        <div class="row-fluid">
                            <a class="btn btn-small btn-box bubble bubble-warning span4 tips" href="#"
                               data-title="bubble-warning" data-bubble="5" style="margin-bottom:0;"><i
                                    class="icon-globe"></i><span>Region</span></a>
                            <a class="btn btn-small btn-box span4 tips" href="#" data-title="" style="margin-bottom:0;"><i
                                    class="icon-search"></i><span>Search</span></a>
                            <a class="btn btn-small btn-box span4 tips" href="#" data-title="" style="margin-bottom:0;"><i
                                    class="icon-cogs"></i><span>Settings</span></a>
                        </div><!-- /row-fluid -->
                        ...
                        <div class="widget-tasks-statistics">
                            <div class="userstats clearfix" style="margin-top: 25px;">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                                    <img src="/atest/Public/assets/img/avatars/07.jpg" class="image">
                                    <div class="widget">
                                        <input class="knob" data-width="75" data-height="75" data-displayInput=false
                                               data-readOnly=true data-thickness=".3" value="85">
                                    </div>
                                    <p>Fernando</p>
                                </a>
                            </div>
                            <div class="userstats clearfix">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                                    <img src="/atest/Public/assets/img/avatars/08.jpg" class="image">
                                    <div class="widget">
                                        <input class="knob" data-width="75" data-height="75" data-displayInput=false
                                               data-readOnly=true data-thickness=".3" value="55">
                                    </div>
                                    <p>Milagros</p>
                                </a>
                            </div>
                            <div class="userstats clearfix">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                                    <img src="/atest/Public/assets/img/avatars/09.jpg" class="image">
                                    <div class="widget">
                                        <input class="knob" data-width="75" data-height="75" data-displayInput=false
                                               data-readOnly=true data-thickness=".3" value="25">
                                    </div>
                                    <p>Lilia</p>
                                </a>
                            </div>
                            <div class="userstats clearfix">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                                    <img src="/atest/Public/assets/img/avatars/10.jpg" class="image">
                                    <div class="widget">
                                        <input class="knob" data-width="75" data-height="75" data-displayInput=false
                                               data-readOnly=true data-thickness=".3" value="15">
                                    </div>
                                    <p>Cody</p>
                                </a>
                            </div>
                            <div class="userstats clearfix">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                                    <img src="/atest/Public/assets/img/avatars/11.jpg" class="image">
                                    <div class="widget">
                                        <input class="knob" data-width="75" data-height="75" data-displayInput=false
                                               data-readOnly=true data-thickness=".3" value="10">
                                    </div>
                                    <p>John</p>
                                </a>
                            </div>
                            <div class="userstats clearfix">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                                    <img src="/atest/Public/assets/img/avatars/12.jpg" class="image">
                                    <div class="widget">
                                        <input class="knob" data-width="75" data-height="75" data-displayInput=false
                                               data-readOnly=true data-thickness=".3" value="9">
                                    </div>
                                    <p>Bryan</p>
                                </a>
                            </div>
            ...
            <div class="row-fluid">
                <div class="widget span4">
                            ...
                            <ul>
                                <li class="priority-high">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="/atest/Public/assets/img/avatars/02.jpg" class="avatar"/>
                                ...
                                <li class="priority-medium">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="/atest/Public/assets/img/avatars/03.jpg" class="avatar"/>
                                        <h5>Login</h5>
                                ...
                                <li class="priority-medium">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="/atest/Public/assets/img/avatars/04.jpg" class="avatar"/>
                                        <h5>Problem</h5>
                                ...
                                <li class="priority-medium">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="/atest/Public/assets/img/avatars/01.jpg" class="avatar"/>
                                        <h5>Problem</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                                        <div class="date">Monday</div>
                                    </a>
                                ...
                                <li class="priority-medium">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="/atest/Public/assets/img/avatars/13.jpg" class="avatar"/>
                                        <h5>A Problem</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                                        <div class="date">Monday</div>
                                    </a>
                                ...
                                <li class="priority-low">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="/atest/Public/assets/img/avatars/12.jpg" class="avatar"/>
                                        <h5>Big Problem</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                                ...
                                <li class="priority-low">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="/atest/Public/assets/img/avatars/08.jpg" class="avatar"/>
                                        <h5>Big Problem</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                                        <div class="date">Yesterday</div>
                                    </a>
                                ...
                                <li class="priority-low">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="/atest/Public/assets/img/avatars/10.jpg" class="avatar"/>
                                        <h5>Big Problem</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                                        <div class="date">Yesterday</div>
                                    </a>
                                ...
                                <li class="priority-low">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                                        <img src="/atest/Public/assets/img/avatars/11.jpg" class="avatar"/>
                                        <h5>Big Problem</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                                        <div class="date">Yesterday</div>
                                    </a>
                    ...
                    <div class="widget-footer">
                        <a href="javascript:void(0)" class="pull-right btn btn-small"><i class="icon-plus"></i> Load
                            More</a>
                    </div>
                </div> <!-- /widget span5 -->
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="comment-bubble">
                                        ...
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus magna ligula,
                                        mattis...
                                        <div class="date">Thursday</div>
                                        <div class="settings">
                                            <a href="javascript:void(0)" class="tip" data-title="Reply"><i
                                                    class="icon-reply"></i></a><a href="javascript:void(0)" class="tip"
                                                                                  data-title="Delete"><i
                                                class="icon-trash"></i></a><a href="javascript:void(0)" class="tip"
                                                                              data-title="Edit"><i
                                                class="icon-edit"></i></a>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <img src="/atest/Public/assets/img/avatars/05.jpg" class="avatar"/>
                                    <div class="comment-bubble">
                                ...
                                <li>
                                    <img src="/atest/Public/assets/img/avatars/06.jpg" class="avatar"/>
                                    <div class="comment-bubble">
            ...
            <div class="row-fluid">
                <div class="widget span12" style="overflow:visible;">
                    <a class="btn btn-box bubble bubble-danger span2 tips" data-title="bubble-danger" href="#"
                       data-bubble="5k"><i class="icon-user"></i><span>Users</span></a>
                    ...
                    <a class="btn btn-box bubble bubble-info span2 tips" data-title="bubble-info" href="#"
                       data-bubble="2"><i class="icon-signal"></i><span>Analytics</span></a>
                    <a class="btn btn-box span2" href="#" data-bubble="2"><i
                            class="icon-lightbulb"></i><span>Tickets</span></a>
                    <a class="btn btn-box bubble bubble-success span2 tips" data-title="bubble-success" href="#"
                       data-bubble="102"><i class="icon-sitemap"></i><span>Categories</span></a>
...
<!-- example modal -->
<div id="example_modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
...
<!-- example modal -->
<div id="example_modal2" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<!-- task_modal modal -->
<div id="task_modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    ...
    <div class="modal-body">
        <div class="clearfix">
            <img src="/atest/Public/assets/img/avatars/11.jpg" class="img-circle"
                 style="float: left; width: 65px; margin-right: 20px;">
...
<!--/warp-->
<script type="text/javascript" src="/atest/Public/assets/js/jquery.min.js"></script>
<script type="text/javascript" src="/atest/Public/assets/js/jquery-ui.min.js"></script>
<script type="text/javascript" src="/atest/Public/assets/js/raphael-min.js"></script>
<script type="text/javascript" src="/atest/Public/assets/js/bootstrap.js"></script>
<script type="text/javascript" src='/atest/Public/assets/js/sparkline.js'></script>
<script type="text/javascript" src='/atest/Public/assets/js/morris.min.js'></script>
<script type="text/javascript" src="/atest/Public/assets/js/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="/atest/Public/assets/js/jquery.masonry.min.js"></script>
<script type="text/javascript" src="/atest/Public/assets/js/jquery.imagesloaded.min.js"></script>
<script type="text/javascript" src="/atest/Public/assets/js/jquery.facybox.js"></script>
<script type="text/javascript" src="/atest/Public/assets/js/jquery.alertify.min.js"></script>
<script type="text/javascript" src="/atest/Public/assets/js/jquery.knob.js"></script>
<script type='text/javascript' src='/atest/Public/assets/js/fullcalendar.min.js'></script>
<script type='text/javascript' src='/atest/Public/assets/js/jquery.gritter.min.js'></script>
<script type="text/javascript" src="/atest/Public/assets/js/realm.js"></script>
<script type="text/javascript" src="/atest/Public/assets/js/jquery.slimscroll.min.js"></script>
</body>
</html>